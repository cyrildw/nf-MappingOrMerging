...
if (!params.merge_bam){
   ...
   */
   ...
   process merge_read_files{
      ...
      """
      ln -s $workflow.launchDir/$params.input_dir/${LibFastq1} ${LibName}_R1.fq.gz
...
if(params.strand_specific_bigwigs){
   ...
   process strand_spec_bw {
      ...
      samtools view -bS ${prefix}.\$strand.sam > ${prefix}.\$strand.bam
      samtools sort  ${prefix}.\$strand.bam  ${prefix}.\$strand.sorted
      samtools index ${prefix}.\$strand.sorted.bam
      bamCoverage \
